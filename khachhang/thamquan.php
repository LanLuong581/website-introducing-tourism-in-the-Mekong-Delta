...
<body>
    <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="thamquan.php">Tham Quan</a>
                            </li>
        ...
        <div class="main-content">
            <div class="thamquan" style="   background-image: url(../image/thamquan2.jpg);
    height: 50vh;
    background-size: cover;">
            ...
            <form action="" method="post">
                ...
                FROM (((((( chitiet_tour
                      ...
                      WHERE account.daily_trangthai='1' && tour.tour_gioithieu != 'NULL' && loai_tour.loaitour_id='2'";
