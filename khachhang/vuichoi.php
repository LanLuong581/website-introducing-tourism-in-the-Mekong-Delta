...
<body>
    <div class="wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="vuichoi.php">Vui Chơi</a>
                            </li>
        ...
        <div class="main-content">
            <div class="vuichoi" style="   background-image: url(../image/vuichoi2.jpg);
    height: 50vh;
    background-size: cover;">
            ...
            <form action="" method="post">
                <div class="row" style="margin: 0;">
                    ...
                    <div class="col-md-8" style="padding-bottom: 50px;background-color: #fff">
                        <h5>Các dịch vụ vui chơi</h5>
                        <!-- product list -->
                ...
                FROM (((((( chitiet_tour
                      ...
                      WHERE account.daily_trangthai='1' && tour.tour_gioithieu != 'NULL' && loai_tour.loaitour_id='1'";
