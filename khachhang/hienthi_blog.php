    ...
    <div class="wrapper">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="diachi">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input type="text" class="form-control" style="border:none" id="update_khachhang_diachi" name="update_khachhang_diachi" value="<?php echo $khachhang_diachi ?>" required>
                                                            </div>
                                                        </div>
        ...
        <div class="main_content" style="background-color: #f8f9fa;">
            <div class="row" style="margin: 0;">
                ...
                <div class="col-md-10" style="background-color: #fff;margin:30px 0px">
                    <?php 
                        $sql_blog="SELECT `blog_tieude`, `blog_noidung`FROM `blog` WHERE id='$id'";
                        ...
                        if(mysqli_num_rows($result_blog)>0){
                            ...
                            ?>
                            <h3 style="text-align: center;"><?php echo $blog_tieude;?></h3>
                            <?php
                            echo $blog_noidung;
                        }
                    ?>
