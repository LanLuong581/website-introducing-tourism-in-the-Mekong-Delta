...
if (isset($_COOKIE["search"])) {
    ...
    var text='rong';
    document.cookie = 'search=' + text + '; expires=Wed, 1 Jan 2022 13:47:11 UTC; path=/';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="main_content" style="background-color: #f8f9fa;padding-top:50px">
            <form action="" method="POST">
                ...
                FROM (((((( chitiet_tour
                      ...
                      WHERE account.daily_trangthai='1' && tour.tour_gioithieu != 'NULL' && tour.tinh_id=$tinh_id";
                        $result_tour = mysqli_query($conn, $sql_tour);
                        if (mysqli_num_rows($result_tour) > 0) {
                        ?>
                            <h4>Tìm thấy <?php echo mysqli_num_rows($result_tour) ?> kết quả cho "<?php echo $ten_tinh ?>"</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="text-align: center;">
                                        <div class="empty-cart" style="background-color: #fff;height:200px;margin-bottom:10%;padding-top:20px;padding-bottom:20px">
                                            <h5>Không tìm thấy kết quả nào cho "<?php echo $ten_tinh ?>"</h5>
