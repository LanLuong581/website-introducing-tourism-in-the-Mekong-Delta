        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    ...
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_chuaxuly.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Đơn hàng chưa xử lý</a></li>
            ...
            <div class="data_table" style="padding-top: 12px;">
                ...
                <div class="donhang_list sap_toi">
                    <h5 style="text-align: center;">Đơn hàng chưa xử lý</h5>
                    <div class="search">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                               ...
                               FROM ((booking
                                     ...
                                     WHERE booking.tour_id='$tour_id' && NOT booking.booking_trangthai='4' && booking.booking_ngaysudung BETWEEN '$from_date' AND '$to_date' && booking.booking_trangthai='0' ORDER BY booking.booking_id DESC";
                            ...
                            ?>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && NOT booking.booking_trangthai='4'  && booking.booking_trangthai='0' ORDER BY booking.booking_id DESC"; 
