        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    ...
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_kh_huy.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Đơn hàng bị hủy</a></li>
            ...
            <div class="data_table" style="padding-top: 12px;">
                <div class="donhang_list tat_ca">
                    <h5 style="text-align: center;">Đơn hàng đã hủy</h5>
                    <div class="search">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                               ...
                               FROM ((booking
                                     ...
                                     WHERE booking.tour_id='$tour_id' && booking.booking_ngaysudung BETWEEN '$from_date' AND '$to_date' && booking.booking_trangthai='3' ORDER BY booking.booking_id DESC";
                            ...
                            ?>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && booking.booking_trangthai='3' ORDER BY booking.booking_id DESC";
                                ...
                                if (mysqli_num_rows($result_booking) > 0) {
                                    ...
                                    ?>
                                        <tr style="background-color: #fff;">
                                            ...
                                            <!-- <td>
                                                <?php
                                                if ($booking_trangthai == 3) {
                                                ?>
                                                    <a class="xoa" href="xoa.php?booking_id=<?php echo $booking_id ?>&key=2"><button type="button" class="bi bi-x-circle" style="border:0px;font-size:20px; color:red;background:none" title="Xóa"></button></a>
