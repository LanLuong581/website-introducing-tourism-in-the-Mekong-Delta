...
Xin chân thành cảm ơn quý đối tác đã tin tưởng và hợp tác.</p>
        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_homnay.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Đơn hàng đã duyệt</a></li>
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_saptoi.php" class="btn button_submit" id="homnay_btn">Đơn hàng đã xuất</a></li>
            ...
            <div class="data_table" style="padding-top: 12px;">
                <div class="donhang_list hom_nay">
                    <h4 style="text-align: center;">Đơn hàng hôm nay</h4>
                        ...
                        FROM ((booking
                            ...
                            ?>
                                    <tr style="background-color: #fff;">
                                        ...
                                        <td>
                                            <?php
                                            if ($booking_trangthai == 1) {
                                            ?>
                                                <a class="xuathoadon" href="xuathoadon.php?id=<?php echo $booking_id ?>"><span class="badge bg-info">Xuất</span></a>
                            ...
                            <div class="col-md-12">
                                <div class="theo_dichvu">
                                    ...
                                    <table class="table" style=" border: 1px solid;text-align:left">
                                        ...
                                        FROM (booking
                                              INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                              WHERE booking.tour_id='$tour_id' && DATE(booking.booking_ngaysudung) = DATE(NOW()) && booking.booking_trangthai='5' ";
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            ...
                                            FROM (booking
                                                  INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                                  WHERE booking.tour_id='$tour_id' && chitiet_tour.chitiet_tour_id='$chitiet_tour_id' && DATE(booking.booking_ngaysudung) = DATE(NOW()) && booking.booking_trangthai='5'";
                ...
                <div class="donhang_list sap_toi">
                    <h4 style="text-align: center;">Đơn hàng sắp tới</h4>
                    <div class="search">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                               ...
                               FROM ((booking
                                     INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                     INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                     WHERE booking.tour_id='$tour_id' && booking.booking_ngaysudung > now() && booking.booking_ngaysudung BETWEEN '$from_date' AND '$to_date' && booking.booking_trangthai='1' ORDER BY booking.booking_id DESC";
                            ...
                            ?>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && booking.booking_ngaysudung > now() && booking.booking_trangthai='1' ORDER BY booking.booking_id DESC";
                                $result_booking = mysqli_query($conn, $sql_booking);
                                if (mysqli_num_rows($result_booking) > 0) {
                                    while ($booking = mysqli_fetch_assoc($result_booking)) {
                                        $booking_id = $booking['booking_id'];
    ...
    <!-- xuat hoa don -->
    <script>
        $('.xuathoadon').on('click', function(e) {
            e.preventDefault();
            var self = $(this);
            console.log(self.data('title'));
            Swal.fire({
    ...
    <script>
        ...
        for (i = 0; i < from_date.length; i++) {
            from_date[i].setAttribute('min', mindate);
        }
        for (i = 0; i < to_date.length; i++) {
            to_date[i].setAttribute('min', mindate);
        }
    </script>
...
?>
        ...
        <script>
            const capnhat = $('.flash-data').data('flashdata')
            if (capnhat) {
                Swal.fire(
                    'Thành công!',
