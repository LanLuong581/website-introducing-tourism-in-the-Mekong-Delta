        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    ...
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_tatca.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Tất cả đơn hàng</a></li>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && NOT booking.booking_trangthai='4' ORDER BY booking.booking_id DESC";
                                    ...
                                    ?>
                                        <tr style="background-color: #fff;">
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <span class="badge bg-danger">KH hủy</span>
                                ...
                                <table class="table" style=" border: 1px solid;text-align:left">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($chitiet = mysqli_fetch_assoc($result)) {
                                            ...
                                            FROM (booking
                                                  INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                                  WHERE booking.tour_id='$tour_id' && chitiet_tour.chitiet_tour_id='$chitiet_tour_id' && NOT booking.booking_trangthai='4'";
