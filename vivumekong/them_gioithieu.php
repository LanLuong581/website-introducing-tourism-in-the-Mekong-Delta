                            ...
                            <div class="col-md-10" style="margin-top:50px;margin-bottom:50px">
                                <form action="" method="post">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <textarea class="form-control" id="tour_gioithieu" name="tour_gioithieu" rows="3" required><?= $tour_gioithieu; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <input class="btn button_submit" type="submit" value="Cập nhật" id="update_gioithieu" name="update_gioithieu">
                                </form>
                            </div>
                            <div class="col-md-1">
                            </div>
...
<?php
$account_id = $_GET['account_id'];
if (isset($_POST["update_gioithieu"])) {
    $tour_gioithieu = $_POST['tour_gioithieu'];
    $sql_gioithieu = "UPDATE `tour` SET `tour_gioithieu`='$tour_gioithieu' WHERE `account_id`='$account_id'";
    if (mysqli_query($conn, $sql_gioithieu)) {
        // echo "<script>alert('cập nhật mục giới thiệu thành công')</script>";
?>
        ...
        <script>
            ...
            if (flashdata) {
                Swal.fire(
                    'Thành công!',
                    'Đã cập nhật nội dung giới thiệu.',
                    'success'
                ).then((result) => {
