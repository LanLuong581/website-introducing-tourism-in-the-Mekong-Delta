        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_homnay.php" class="btn button_submit" id="homnay_btn">Đơn hàng đã duyệt</a></li>
                    ...
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_dahuy.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Đơn hàng đã từ chối</a></li>
            ...
            <div class="data_table" style="padding-top: 12px;">
                ...
                <div class="donhang_list sap_toi">
                    <h5 style="text-align: center;">Đơn hàng đã từ chối</h5>
                    <div class="search">
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                               ...
                               FROM ((booking
                                     ...
                                     WHERE booking.tour_id='$tour_id'  && booking.booking_ngaysudung BETWEEN '$from_date' AND '$to_date' && booking.booking_trangthai='2' ORDER BY booking.booking_id DESC";
                            ...
                            ?>
                                        <tr style="background-color: #fff;">
                                            ...
                                            <!-- <td>
                                                ...
                                                ?>
                                                    ...
                                                    <a class="xoa" href="xoa.php?booking_id=<?php echo $booking_id ?>$key=1"><button type="button" class="bi bi-x-circle" style="border:0px;font-size:20px; color:red;background:none" title="Xóa"></button></a>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && booking.booking_trangthai='2'  ORDER BY booking.booking_id DESC";
...
if (isset($_POST["change_submit"])) {
    ...
    if (mysqli_num_rows($result_pass) > 0) {
        ...
        ?>
                ...
                <div class="flash-data" data-flashdata=1></div>
                <script>
                    const matkhau = $('.flash-data').data('flashdata')
                    if (matkhau) {
                        Swal.fire(
                            'Thành công!',
