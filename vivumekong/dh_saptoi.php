        ...
        <div class="main-content" style="background-color: #f8f9fa;min-height:80vh">
            <div class="control" style="padding-top: 12px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ul_btn">
                    ...
                    <li class="nav-item li_btn"> <a href="../vivumekong/dh_saptoi.php" class="btn button_submit" id="homnay_btn" style="background-color: #ef476f;">Đơn hàng đã xuất</a></li>
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                               ...
                               FROM ((booking
                                     ...
                                     WHERE booking.tour_id='$tour_id' && booking.booking_ngaysudung BETWEEN '$from_date' AND '$to_date' && booking.booking_trangthai='5'  ORDER BY booking.booking_id DESC";
                            ...
                            ?>
                                ...
                                FROM ((booking
                                      INNER JOIN chitiet_tour ON chitiet_tour.chitiet_tour_id=booking.chitiet_tour_id)
                                      INNER JOIN booking_khachhang ON booking_khachhang.kh_id=booking.kh_id)
                                      WHERE booking.tour_id='$tour_id' && booking.booking_trangthai='5' ORDER BY booking.booking_id DESC";
